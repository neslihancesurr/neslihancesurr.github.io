...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "You can access my full CV by clicking on the PDF icon!",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-the-java-repo-and-slides-for-cs201-data-structures-amp-amp-algorithms-course-are-now-on-my-github",
          title: 'The Java repo and slides for CS201 Data Structures &amp;amp;amp; Algorithms course are...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%65%73%6C%69%68%61%6E.%63%65%73%75%72@%6F%7A%75.%65%64%75.%74%72", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/neslihancesurr", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=xcHEB0EAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
